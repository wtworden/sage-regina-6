...
setup(name = 'regina6',
      version = version,
      zip_safe = False,
      description = 'Python 3.11 compatible build of Regina 6',
      ...
      maintainer = 'Will Worden',
      maintainer_email = 'wtworden@gmail.com',
      url = 'http://github.com/wtworden/sage-regina-6',
      license='GPLv2+',
      packages = [
          'regina',
          'regina/pyCensus',
